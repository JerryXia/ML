...
namespace Mono.Data.SqliteClient
{
    ...
    {
        public SqliteSyntaxException()
            : this("An error occurred compiling the Sqlite command.")
        {
        }
        ...
        public SqliteSyntaxException(string message, Exception cause)
            : base(message, cause)
        {
        }
    }
    ...
    public class SqliteExecutionException : ApplicationException
    {
        public SqliteExecutionException()
            : this("An error occurred executing the Sqlite command.")
        {
        }
        ...
        public SqliteExecutionException(string message, Exception cause)
            : base(message, cause)
        {
        }
    }
    ...
    public class SqliteBusyException : SqliteExecutionException
    {
        ...
        public SqliteBusyException(string message, Exception cause)
            : base(message, cause)
        {
        }
    }
