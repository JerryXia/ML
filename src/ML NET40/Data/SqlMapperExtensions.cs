    ...
    public static class SqlMapperExtensions
    {
        ...
        class ProxyGenerator
        {
            ...
            public static T GetInterfaceProxy<T>()
            {
                ...
                var interfaceType = typeof(ML.Data.SqlMapperExtensions.IProxy);
            ...
            private static MethodInfo CreateIsDirtyProperty(TypeBuilder typeBuilder)
            {
                ...
                var getMethod = typeof(ML.Data.SqlMapperExtensions.IProxy).GetMethod("get_" + "IsDirty");
                var setMethod = typeof(ML.Data.SqlMapperExtensions.IProxy).GetMethod("set_" + "IsDirty");
